...
export const DashboardTrial = () => {
    ...
    return (
        <div className="border border-border/10 w-full rounded-lg flex flex-col gap-y-2">
            ...
            <Button asChild 
            className="border-t rounded-t-none hover:bg-white/10 bg-transparent border-border/10">
                <Link href="/upgrade">
                Upgrade
                </Link>
            </Button>
