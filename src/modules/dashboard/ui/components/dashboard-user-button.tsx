...
export const DashboardUserButton = () => {
    ...
    if (isMobile) {
        return (
            <Drawer>
                <DrawerTrigger className="p-3 rounded-lg border border-border/10 w-full flex
            items-center justify-between gap-x-2 bg-white/5 hover:bg-white/10 overflow-hidden">
                    {data.user.image ? (
                        <Avatar>
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger className="p-3 rounded-lg border border-border/10 w-full flex
            items-center justify-between gap-x-2 bg-white/5 hover:bg-white/10 overflow-hidden">
                {data.user.image ? (
                    <Avatar>
                        <AvatarImage src={data.user.image} />
