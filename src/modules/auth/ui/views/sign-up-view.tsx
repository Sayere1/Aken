    ...
    return (
        <div className="flex flex-col gap-6">
                    ...
                    <Form {...form} >
                        <form className="p-6 md:p-8" onSubmit={form.handleSubmit(onSubmit)}>
                            <div className="flex flex-col gap-6">
                                    ...
                                    <FormField control={form.control} name="name"
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Input type="text" placeholder="your names" {...field} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )} />
                                ...
                                <div className="after:border-border relative text-center text-sm after:border-t
                                after:absolute after:inset-0 after:top1/2 after:z-0 after:flex after:text-center">
            ...
            *:[a]:underline *:[a]:underline-offset-4">
                By clicking you agree to our <a href="#"> terms of service </a> and <a href="#">Privacy polices</a>
            </div>
        </div>
    );
};